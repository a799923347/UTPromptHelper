...
- 🖱️ **右键菜单支持**：在文件上右键即可快速生成UT提示词

## 🚀 安装方法

### 方法一：从 JAR 文件安装

1. 下载插件包：`UTPromptHelper-v2.2.jar`
2. 打开 IntelliJ IDEA
...
### v2.2.0
- ✨ **新增右键菜单功能**：在文件上右键即可快速生成UT提示词
- 🔄 **功能对齐**：右键菜单与Tools菜单使用相同的UI和逻辑
- 🎯 **文件范围优化**：右键菜单只分析当前选中文件的变更
- 📝 **文档更新**：完善使用指南和功能说明
